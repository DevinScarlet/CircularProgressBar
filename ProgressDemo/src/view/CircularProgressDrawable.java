...
import view.anim.Animator;
import view.anim.ArgbEvaluator;
import view.anim.ValueAnimator;
...
public class CircularProgressDrawable extends Drawable implements Animatable {
	...
	public static class Builder {
		...
		public Builder strokeWidth(float strokeWidth) {
			CircularProgressBarUtils.checkPositiveOrZero(strokeWidth,
					"StrokeWidth");
		...
		public Builder sweepInterpolator(Interpolator interpolator) {
			CircularProgressBarUtils.checkNotNull(interpolator,
					"Sweep interpolator");
